export default {
  ...
  contact: {
    title: '联系我们',
    description: '通过QQ或邮箱联系我们的团队，获取支持与咨询。',
    wechatTitle: 'QQ',
    wechatDescription: '扫描下方二维码，连接我们的官方QQ客服账号。',
    qrLoading: '正在生成二维码...',
    emailTitle: '邮箱',
  ...
  // Setup Wizard
  setup: {
    title: 'pineai.net 安装向导',
    description: '配置您的 pineai.net 实例',
    database: {
      title: '数据库配置',
  ...
  admin: {
    ...
    backup: {
      ...
      r2Guide: {
        ...
        step1: {
          ...
          line2: '点击「创建存储桶」，输入名称（如 pineai.net-backups），选择区域',
          line3: '点击创建完成'
        },
        step2: {
          title: '创建 API 令牌',
    ...
    accounts: {
      ...
      usageWindowsHint: '“5h / 7d”是上游账号（如 OpenAI ChatGPT、Claude）官方的滚动用量窗口限制，由上游对账号设定，并非 pineai.net 配置，也与你映射的模型无关。窗口滚动到期后用量会自动重置，无法在 pineai.net 端解除该限制。',
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 pineai.net 实例的场景。',
    ...
    settings: {
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 pineai.net 用户登录',
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 pineai.net 用户登录',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 pineai.net',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">pineai.net 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 pineai.net 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 pineai.net',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 pineai.net AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
  ...
  docs: {
    ...
    nodejs: {
      ...
      tip: '提示：后续的 Claude Code、Codex 都依赖 Node.js 运行环境。先完成本教程，再继续各自工具配置。',
      windows: 'Windows',
      windowsMethod1: '方法一：官方下载（推荐）—— 前往 <a href="https://nodejs.org/zh-cn" target="_blank" rel="noopener noreferrer">Node.js 官网</a> 下载 LTS 安装包并安装。',
      windowsMethod2: '方法二：使用 <a href="https://chocolatey.org/" target="_blank" rel="noopener noreferrer">Chocolatey</a>',
      windowsMethod3: '方法三：使用 <a href="https://scoop.sh/" target="_blank" rel="noopener noreferrer">Scoop</a>',
      macos: 'macOS',
      macosMethod1: '方法一：官方下载（推荐）—— 前往 <a href="https://nodejs.org/zh-cn" target="_blank" rel="noopener noreferrer">Node.js 官网</a> 下载 macOS 安装包。',
      macosMethod2: '方法二：使用 <a href="https://brew.sh/" target="_blank" rel="noopener noreferrer">Homebrew</a>',
      linux: 'Linux',
      linuxMethod1: '推荐通过 <a href="https://github.com/nvm-sh/nvm" target="_blank" rel="noopener noreferrer">nvm</a> 安装 LTS 版本，便于多版本管理：',
      verify: '验证安装',
    ...
    codex: {
      ...
      configTitle: '配置文件',
      configDescription: '在 ~/.codex 目录下创建 config.toml 和 auth.json，将 YOUR_API_KEY 替换为 <a href="/keys" target="_blank" rel="noopener noreferrer">API 密钥管理</a> 中创建的密钥。',
      verifyTitle: '验证配置',
    ...
    claudeCode: {
      ...
      envTitle: '环境变量配置',
      envDescription: '将以下环境变量添加到终端配置文件（~/.bashrc、~/.zshrc）或直接在终端中运行。将 YOUR_API_KEY 替换为 <a href="/keys" target="_blank" rel="noopener noreferrer">API 密钥管理</a> 中创建的密钥。',
  ...
  modelPricing: {
    ...
    pricingRules: '计价规则',
    pricingRulesText: '官方价格按$1=¥7折算 分组价格(人民币)=官方价格(美元)×分组倍率',
    example: '示例',
    inputPrice: '输入价',
    official: '官方',
    groupPrice: '分组价格',
