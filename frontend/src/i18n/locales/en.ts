export default {
  ...
  docs: {
    ...
    nodejs: {
      ...
      tip: 'Tip: Claude Code and Codex both depend on Node.js. Complete this guide first before configuring each tool.',
      windows: 'Windows',
      windowsMethod1: 'Method 1: Official download (recommended) — download the LTS installer from the <a href="https://nodejs.org/" target="_blank" rel="noopener noreferrer">Node.js website</a>.',
      windowsMethod2: 'Method 2: Using <a href="https://chocolatey.org/" target="_blank" rel="noopener noreferrer">Chocolatey</a>',
      windowsMethod3: 'Method 3: Using <a href="https://scoop.sh/" target="_blank" rel="noopener noreferrer">Scoop</a>',
      macos: 'macOS',
      macosMethod1: 'Method 1: Official download (recommended) — download the macOS installer from the <a href="https://nodejs.org/" target="_blank" rel="noopener noreferrer">Node.js website</a>.',
      macosMethod2: 'Method 2: Using <a href="https://brew.sh/" target="_blank" rel="noopener noreferrer">Homebrew</a>',
      linux: 'Linux',
      linuxMethod1: 'Recommended: install the LTS version via <a href="https://github.com/nvm-sh/nvm" target="_blank" rel="noopener noreferrer">nvm</a> for easier version management:',
    ...
    codex: {
      ...
      configDescription: 'Create config.toml and auth.json under ~/.codex. Replace YOUR_API_KEY with a key from the <a href="/keys" target="_blank" rel="noopener noreferrer">API Keys</a> page.',
    ...
    claudeCode: {
      ...
      envDescription: 'Add the following variables to your shell profile (~/.bashrc, ~/.zshrc) or run them directly in the terminal. Replace YOUR_API_KEY with a key from the <a href="/keys" target="_blank" rel="noopener noreferrer">API Keys</a> page.',
